...
import com.xrds.basic.component.service.bussiness.bean.LockBaseBean;

/**
 * 
 * 
 * @author liukai
 * @version $Id: MessageBaseInfo.java, v 0.1 2016年3月17日 上午10:54:36 liukai Exp $
 */
public class MessageBaseInfo extends LockBaseBean {
  /** 主键ID */
  private BigInteger id;
  /** 消息类型 sms：短信，email：邮件，mq：MQ */
