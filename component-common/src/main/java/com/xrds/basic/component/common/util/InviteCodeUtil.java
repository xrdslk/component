 ...
 * 
 * @author GSZY
 * @version $Id: InviteCodeUtil.java, v 0.1 2018年8月27日 下午2:04:43 GSZY Exp $
 */
public class InviteCodeUtil {

  /**
   * 自定义进制(0,1没有加入,容易与o,l混淆)，数组顺序可进行调整增加反推难度，A用来补位因此此数组不包含A，共32个字符。
   */
  private static final char[] BASE = new char[] {'H', 'V', 'E', '8', 'S', '2', 'D', 'Z', 'X', '9',
      'C', '7', 'P', '5', 'I', 'K', '3', 'M', 'J', 'U', 'F', 'R', '4', 'W', 'Y', 'L', 'T', 'N',
      '6', 'B', 'G', 'Q'};
   ...
   * shareCode最小长度
   */
  public static final int SHARE_CODE_LEN = 16;
   ...
   * @return
   */
  public static String idToCode(Long id, int length) {
  ...
  public static void main(String[] args) {
    String shareCode = InviteCodeUtil.idToCode(2019012110170099999l, SHARE_CODE_LEN);
    System.out.println(shareCode);

    System.out.println(InviteCodeUtil.codeToId(shareCode));
