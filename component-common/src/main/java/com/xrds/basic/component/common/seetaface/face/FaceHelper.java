...
import com.xrds.basic.component.common.seetaface.face.model.FaceLandmark;
...
public class FaceHelper {
  ...
  public static SeetaFace2JNI seeta = SeetafaceBuilder.build();

  //
  // public staSeetaFace2JNI getSeetaFace2JNI() {
  // return this.seeta;
  // }
